...
public class Authentication {
	...
	public Authentication() {
        mssql = new MSSQL("jdbc:sqlserver://cryptofileserver.database.windows.net:1433;database=cryptofile;user=db_writer_reader@cryptofileserver;password=CryptoFileHasACoolPassword1;encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;");
	}
